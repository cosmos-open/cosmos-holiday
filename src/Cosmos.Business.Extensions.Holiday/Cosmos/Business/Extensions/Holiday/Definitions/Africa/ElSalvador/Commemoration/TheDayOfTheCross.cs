...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Africa.ElSalvador.Commemoration
{
    ...
    /// </summary>
    public class TheDayOfTheCross : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Día de la Cru";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_sv_cross_day";
    }
}