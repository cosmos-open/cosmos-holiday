...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Africa.Namibia.Religion
{
    /// <summary>
    /// Easter Monday
    /// </summary>
    public class EasterMonday : CatholicVariableHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_na_easter_monday";
    }
}