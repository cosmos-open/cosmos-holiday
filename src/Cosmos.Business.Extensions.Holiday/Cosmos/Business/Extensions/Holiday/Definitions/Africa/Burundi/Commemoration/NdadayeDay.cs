...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Africa.Burundi.Commemoration
{
    ...
    /// fr: Jour de Ndadaye
    /// </summary>
    public class NdadayeDay : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Jour de Ndadaye";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_bi_ndadaye";
    }
}