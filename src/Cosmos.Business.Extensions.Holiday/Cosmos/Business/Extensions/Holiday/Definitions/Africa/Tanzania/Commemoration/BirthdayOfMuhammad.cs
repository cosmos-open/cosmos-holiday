...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Africa.Tanzania.Commemoration
{
    /// <summary>
    ...
    public class BirthdayOfMuhammad: IslamicVariableHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_tz_birthday_muhammad";
    }
}