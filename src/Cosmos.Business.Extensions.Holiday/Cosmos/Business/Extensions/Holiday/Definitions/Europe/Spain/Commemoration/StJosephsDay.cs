...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.Spain.Commemoration
{
    ...
    public class StJosephsDay : BaseFixedHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override List<string> RegionCodes { get; set; } = new List<string> {"ES-ML", "ES-CM", "ES-GA", "ES-IB", "ES-M", "ES-MU", "ES-NA", "ES-O", "ES-VC"};
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_es_stjosephs_day";
    }
}