...
{
    /// <summary>
    /// New Year's Day for GB-NIR
    /// </summary>
    public class NewYearsDayNir : BaseVariableHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_gb_newyearsday_nir";
