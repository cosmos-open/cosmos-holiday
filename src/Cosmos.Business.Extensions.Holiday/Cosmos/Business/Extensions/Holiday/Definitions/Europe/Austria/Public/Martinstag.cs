...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.Austria.Public
{
    ...
    /// Martinstag
    /// </summary>
    public class Martinstag : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string RegionCode { get; } = "AT-1";

        /// <inheritdoc />
        public override string Name { get; } = "Martinstag";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_at_martinstag";
    }
}