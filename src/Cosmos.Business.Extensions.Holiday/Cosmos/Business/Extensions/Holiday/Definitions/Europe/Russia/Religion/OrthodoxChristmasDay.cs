...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.Russia.Religion
{
    /// <summary>
    ...
    public class OrthodoxChristmasDay : BaseFixedHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_ru_orthodox_christmas";
    }
}