...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.Germany.Religion
{
    ...
    /// </summary>
    public class RepentanceAndPrayerDay8189 : CatholicVariableHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override List<string> RegionCodes { get; set; } =
            new List<string> {"DE-BW", "DE-BY", "DE-BE", "DE-HB", "DE-HH", "DE-HE", "DE-NI", "DE-NW", "DE-RP", "DE-SL", "DE-SH"};
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_de_prayer_day_8189";

        /// <inheritdoc />
        public override int? Since { get; } = 1981;
