...
{
    /// <summary>
    /// Ordino Annual Festival
    /// </summary>
    public class OrdinoAnnualFestival : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Ordino";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_ad_ordino";
    }
}