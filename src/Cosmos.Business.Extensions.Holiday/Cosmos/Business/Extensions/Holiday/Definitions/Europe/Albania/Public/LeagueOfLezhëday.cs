...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.Albania.Public
{
    ...
    /// League of Lezhë day
    /// </summary>
    public class LeagueOfLezhëday : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Dita e Besëlidhjes së Lezhës";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_al_league_of_lezhe";
    }
}