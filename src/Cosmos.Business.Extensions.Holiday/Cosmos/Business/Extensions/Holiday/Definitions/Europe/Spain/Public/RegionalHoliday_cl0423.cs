...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.Spain.Public
{
    ...
    /// Regional Holiday
    /// </summary>
    public class RegionalHoliday_cl0423 : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string RegionCode { get; } = "ES-CL";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_es_regional_holiday_cl0423";
    }
}