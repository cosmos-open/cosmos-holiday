...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.SvalbardAndJanMayen.Commemoration
{
    /// <summary>
    /// Constitution Day
    /// </summary>
    public class ConstitutionDay : BaseFixedHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_sj_constitution";
    }
}