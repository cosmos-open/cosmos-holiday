...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.Malta.Commemoration
{
    ...
    /// Feast of St. Joseph
    /// </summary>
    public class StJoseph : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "San Ġużepp";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_mt_joseph";
    }
}