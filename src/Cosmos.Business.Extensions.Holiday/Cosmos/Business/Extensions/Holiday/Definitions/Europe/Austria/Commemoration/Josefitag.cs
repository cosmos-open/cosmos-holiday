...
{
    /// <summary>
    /// Josefitag / Saint Joseph
    /// </summary>
    public class Josefitag : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Josefitag";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_at_josefitag";
    }
}