...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.Albania.Commemoration
{
    /// <summary>
    /// Mother Teresa Day
    /// </summary>
    public class MotherTeresaDay : BaseFixedHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_al_mother_teresa";
    }
}