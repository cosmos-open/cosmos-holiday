...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.Belarus.Religion
{
    ...
    /// Christmas Day
    /// </summary>
    public class CatholicChristmasDay : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Каляды каталiцкiя";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_by_christmas";
    }
}