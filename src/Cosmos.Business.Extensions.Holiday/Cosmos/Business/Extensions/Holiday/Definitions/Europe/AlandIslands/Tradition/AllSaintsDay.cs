...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Europe.AlandIslands.Tradition
{
    /// <summary>
    /// All Saints' Day
    /// </summary>
    public class AllSaintsDay : WeekOffsetVariableHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_ax_all_saints";
    }
}