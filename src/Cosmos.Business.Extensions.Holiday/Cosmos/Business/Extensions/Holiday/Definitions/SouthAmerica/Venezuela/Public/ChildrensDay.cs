...
namespace Cosmos.Business.Extensions.Holiday.Definitions.SouthAmerica.Venezuela.Public
{
    ...
    /// Children's Day
    /// </summary>
    public class ChildrensDay : WeekOffsetVariableHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Dia del niño";

        /// <inheritdoc />
        public override HolidayType HolidayType { get; set; } = HolidayType.Public;

        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_ve_children";
