...
namespace Cosmos.Business.Extensions.Holiday.Definitions.SouthAmerica.Colombia.Public
{
    ...
    /// </summary>
    public class IndependenceOfCartagena : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Independencia de Cartagena";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_co_independence_cartagena";
    }
}