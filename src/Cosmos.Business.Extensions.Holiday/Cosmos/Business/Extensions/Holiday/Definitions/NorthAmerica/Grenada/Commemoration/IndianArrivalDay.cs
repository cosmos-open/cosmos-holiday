...
namespace Cosmos.Business.Extensions.Holiday.Definitions.NorthAmerica.Grenada.Commemoration
{
    /// <summary>
    /// Indian Arrival Day
    /// </summary>
    public class IndianArrivalDay : BaseFixedHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_gd_indian_arrival";
    }
}