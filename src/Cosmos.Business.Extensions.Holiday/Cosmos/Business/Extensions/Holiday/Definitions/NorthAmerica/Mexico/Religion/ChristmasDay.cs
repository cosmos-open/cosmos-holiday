...
namespace Cosmos.Business.Extensions.Holiday.Definitions.NorthAmerica.Mexico.Religion
{
    /// <summary>
    /// Christmas Day
    /// </summary>
    public class ChristmasDay : BaseFixedHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_mx_christmas";
    }
}