...
namespace Cosmos.Business.Extensions.Holiday.Definitions.NorthAmerica.Canada.Religion
{
    ...
    /// Easter Monday
    /// </summary>
    public class EasterMondayAbPe : CatholicVariableHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override List<string> RegionCodes { get; set; } = new List<string> {"CA-AB", "CA-PE"};
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_ca_easter_mondays_ab_pe";
    }
}