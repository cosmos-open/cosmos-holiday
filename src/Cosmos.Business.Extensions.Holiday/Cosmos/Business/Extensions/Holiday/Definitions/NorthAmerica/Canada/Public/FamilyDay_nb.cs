...
namespace Cosmos.Business.Extensions.Holiday.Definitions.NorthAmerica.Canada.Public
{
    ...
    /// Family Day
    /// </summary>
    public class FamilyDayNb : BaseVariableHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string RegionCode { get; } = "CA-NB";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_ca_family_nb";
