...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Oceania.Tonga.Public
{
    ...
    /// Constitutional Day
    /// </summary>
    public class ConstitutionalDay : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Constitutional Day";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_to_constitutional";
    }
}