...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Asia.Azerbaijan.Public
{
    ...
    /// </summary>
    public class AzerbaijanArmedForcesDay : WeekShiftVariableHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Azərbaycan Respublikasının Silahlı Qüvvələri günü";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_az_army";
    }
}