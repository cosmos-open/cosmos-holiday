...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Asia.Azerbaijan.Public
{
    ...
    public class IndependenceDay : WeekShiftVariableHolidayFunc
    {
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Dövlət Müstəqilliyi günü";
        ...
        /// <inheritdoc />
        public override int Day { get; } = 18;
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_az_independence";
    }
}