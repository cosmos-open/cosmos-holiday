...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Asia.Japan.Public
{
    ...
    /// Mountain Day
    /// </summary>
    public class MountainDay : BaseVariableHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "山の日";

        /// <inheritdoc />
        public override HolidayType HolidayType { get; set; } = HolidayType.Public;

        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_jp_mountainday";
