...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Asia.Cyprus.Religion
{
    ...
    /// Ash Sunday
    /// </summary>
    public class AshSunday : CatholicVariableHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Ash Sunday";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_cy_ash_sunday";
    }
}