...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Asia.Azerbaijan.Public
{
    ...
    /// </summary>
    public class NationalSalvationDay : WeekShiftVariableHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Azərbaycan xalqının Milli Qurtuluş günü";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_az_national_salvation";
    }
}