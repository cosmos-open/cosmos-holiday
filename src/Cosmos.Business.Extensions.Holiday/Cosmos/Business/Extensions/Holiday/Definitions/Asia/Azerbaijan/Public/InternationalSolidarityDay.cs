...
namespace Cosmos.Business.Extensions.Holiday.Definitions.Asia.Azerbaijan.Public
{
    ...
    /// </summary>
    public class InternationalSolidarityDay : BaseFixedHolidayFunc
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Dünya azərbaycanlıların həmrəyliyi günü";
        ...
        /// <inheritdoc />
        public override string I18NIdentityCode { get; } = "i18n_holiday_az_solidarity";
    }
}